/* ── recs-auth.js — theme, auth panel, auth gate, session management ── */
...
function showPage() {
  ...
  loadSavedSearches();
  loadExchangeTicker();
  // Load saved WhatsApp / CallMeBot credentials
  if (_currentUser) {
  ...
  // Auto-run lookup if arriving from profile page
